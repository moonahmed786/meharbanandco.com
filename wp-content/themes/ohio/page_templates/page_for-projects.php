		...
		<div class="page-content<?php echo esc_attr( $sidebar_page_class ); ?>">
			<main id="main" class="site-main">
								...
								<?php if ( is_array( $cat_ids ) && $cat_ids ) : ?>
									...
									<div class="portfolio-filter<?php echo esc_attr( $filter_classes ); ?>"
										...
										<ul class="-unlist">
											...
											<li>
												<a class="active -unlink<?php if ( $filter_layout == 'button' ) { echo esc_attr( ' tag'); } ?>" href="#all" data-isotope-filter="*" data-category-count="<?php echo str_pad( (string)$published_projects, 2, '0', STR_PAD_LEFT ); ?>">
											...
											<?php foreach ( $cat_ids as $cat_obj ) : ?>
												...
												?>
												<li>
													<a class="-unlink<?php if ( $filter_layout == 'button' ) { echo esc_attr( ' tag'); } ?>" href="#<?php echo esc_attr( $cat_obj->slug ); ?>" data-isotope-filter=".ohio-filter-project-<?php echo hash( 'md4', $cat_obj->slug, false ); ?>" data-category-count="<?php echo esc_attr( $cat_obj->count ); ?>">
				...
				<?php if ( $is_slider ) : ?>
					...
					<div class="scroll-bar-container <?php echo esc_attr( $project_layout ); ?>">
