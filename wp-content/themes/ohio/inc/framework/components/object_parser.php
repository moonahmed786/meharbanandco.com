        ...
        if ( $project_object['show_sharing'] && $project_object['sharing_links'] && count( $project_object['sharing_links'] ) > 0 ) {
            ...
            foreach( $project_object['sharing_links'] as $share_link ) {
                ...
                if ( $share_link == 'twitter' ) : ?>
                    <a class="-unlink" href="https://x.com/intent/tweet?text=<?php echo urlencode( $project_object['title'] ); ?>,+<?php echo rawurlencode( get_permalink() ); ?>" <?php echo esc_attr( $target_blank ); ?> class="twitter">
