    ...
    <div class="social-bar">
        <ul class="social-bar-holder titles-typo -small-t -unlist<?php echo esc_attr( $social_classes ); ?>">
            ...
            <?php while ( have_rows( 'global_header_menu_social_links', 'option' ) ): the_row(); ?>
                ...
                ?>
                <li>
                    <a class="-unlink <?php echo $social_network; ?>" href="<?php echo esc_url( $social_network_url ); ?>" target="<?php echo $link_target; ?>" rel="nofollow"><?php echo $social_icons == 'icons' ? '<i class="fa-brands ' . $icon . '"></i>' : $text; ?>
                    </a>
                </li>
            <?php endwhile; ?>
        </ul>
