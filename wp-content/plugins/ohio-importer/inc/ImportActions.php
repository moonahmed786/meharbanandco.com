...
class ImportActions {
	...
	public function update_elementor_options() {
		...
		if ( !empty( $active_kit ) ) {
			...
			$settings['container_width'] = [ 'unit' => 'px', 'size' => '1300' ];
			$settings['container_padding'] = [ 'unit' => 'px', 'top' => '0', 'right' => '20', 'bottom' => '0', 'left' => '20' ];
			$settings['space_between_widgets'] = [ 'unit' => 'px', 'column' => '0', 'row' => '0' ];
