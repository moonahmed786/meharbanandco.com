	...
	function ajaxCall( data ) {
		...
		.done( function( response ) {
			if ( 'undefined' !== typeof response.status && 'newAJAX' === response.status ) {
				...
				$( '.js-ocdi-ajax-response' ).append( '<div class="notice o-notice error notice-error"><div class="holder"><i class="bi bi-exclamation-triangle"></i><p>' + response + '</p><a target="_blank" class="btn" href="https://colabrio.ticksy.com/">Need Help?</a></div></div>' );
				$( '.js-ocdi-ajax-loader' ).hide();
			}
		})
		.fail( function( error ) {
			$( '.js-ocdi-ajax-response' ).append( '<div class="notice o-notice error notice-error"><div class="holder"><i class="bi bi-exclamation-triangle"></i><p>Error: ' + error.statusText + ' (' + error.status + ')' + '&nbsp;<b>Try to repeat an action again.</b></p><a target="_blank" class="btn" href="https://colabrio.ticksy.com/">Need Help?</a></div></div>' );
			$( '.js-ocdi-ajax-loader' ).hide();
		});
	}
