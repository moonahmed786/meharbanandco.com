...
<div class="vc_row portfolio-grid<?php if ( preg_replace("/[^0-9.]/", '', (string) $settings['grid_items_gap'] ) == '0' ) { echo esc_html( ' -nospace' ); } ?>" data-projects-per-page="<?php echo $per_page?>" data-isotope-grid="true" data-lazy-container="projects" data-tilt-effect="true">
