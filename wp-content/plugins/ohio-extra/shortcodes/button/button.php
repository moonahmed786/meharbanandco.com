...
function ohio_button_func( $atts ) {
	...
	*/
	...
	if ( $button_color ) {
		$_style_block .= '#' . $wrapper_id . '.button:not(.-outlined):not(.-text):not(.-flat):not(.-primary):not(.page-link):not(:hover){';
	...
	if ( $button_border_hover_color ) {
		$_style_block .= '#' . $wrapper_id . '.button:not(.-flat):not(.-text):hover{';
