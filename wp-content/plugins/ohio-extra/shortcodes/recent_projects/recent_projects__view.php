	...
	<?php if ( $show_projects_filter && !$is_slider ) : ?>
		...
		>
			<ul class="-unlist">
				...
				<li>
                    <a class="active -unlink<?php if ( $filter_layout == 'button' ) { echo esc_attr( ' tag'); } ?>" href="#all" data-isotope-filter="*" data-category-count="<?php echo str_pad( (string)$all_projects_count, 2, '0', STR_PAD_LEFT ); ?>">
